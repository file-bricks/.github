...
## Current Public Index (2026-07-26)

| Repository | Focus / Purpose | Platform | Primary Tech |
|---|---|---|---|
| [`.github`](https://github.com/file-bricks/.github) | Organization profile, community standards & ecosystem index | Cross-platform | Markdown, YAML |
...
| [`ProfiPrompt`](https://github.com/file-bricks/ProfiPrompt) | Desktop prompt manager with versions, boards & PWA companion | Windows / Web | Python, PySide6, JS |
...
## Shared Community Standards & Workflows

This repository provides default GitHub health assets across the `file-bricks` organization:
